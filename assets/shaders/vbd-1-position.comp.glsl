...
layout(std430, binding = 2) buffer CurrPositions {
...
void main() {
  ...
  vec3 position_i = vec3(g_curr_positions[3 * vid + 0],
                         g_curr_positions[3 * vid + 1],
                         g_curr_positions[3 * vid + 2]) + 0.0001;
  ...
  g_curr_positions[3 * vid + 0] = position_i.x;
  g_curr_positions[3 * vid + 1] = position_i.y;
  g_curr_positions[3 * vid + 2] = position_i.z;
}
